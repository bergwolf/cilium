...
func (ds *PolicyTestSuite) TestL4Policy(c *C) {
				...
				api.IngressRule{
					ToPorts: []api.PortRule{{
						Ports: []api.PortProtocol{
							api.PortProtocol{Port: 80, Protocol: "tcp"},
							api.PortProtocol{Port: 8080, Protocol: "tcp"},
						},
					}},
				},
			},
	...
	expected.Ingress["tcp:80"] = L4Filter{Port: 80, Protocol: "tcp"}
	expected.Ingress["tcp:8080"] = L4Filter{Port: 8080, Protocol: "tcp"}
